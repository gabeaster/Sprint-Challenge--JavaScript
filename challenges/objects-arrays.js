...
DONE- LOG CORRECT "(10) ["Coastal Carolina University", "Fachhochschule Rosenheim, Hochschule für Technik und Wirtschaft", "International Medical & Technological University", "Marian College", "Missouri Southern State College", "Salem University", "Sultan Salahuddin Abdul Aziz Shah Polytechnic", "The School of the Art Institute of Chicago", "Universidad Católica de Ávila", "Universitat Rovira I Virgili Tarragona"]"
...
unisWithUni.push(graduates.filter(function(grad){
  return grad.university.toLowerCase().indexOf('uni') !== -1
}))
